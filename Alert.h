...
struct NodeResult {
    boost::shared_ptr<StateNode<ReturnType> > nextNode;
    boost::shared_ptr<ReturnType> result;
    NodeResult(const boost::shared_ptr<StateNode<ReturnType> > &nextNode =
	       boost::shared_ptr<StateNode<ReturnType> >(),
	       const boost::shared_ptr<ReturnType> &result = boost::shared_ptr<ReturnType>()):
...
class StateMachine: public StateNode<ReturnType>{
    boost::shared_ptr<StateNode<ReturnType> > currentNode;
 public:
    StateMachine(const boost::shared_ptr<StateNode<ReturnType> >& initialNode);
    virtual  NodeResult<ReturnType> handleEvent(StateEventType event);
};
...
template<class ReturnType>
StateMachine<ReturnType>::StateMachine(const boost::shared_ptr<StateNode<ReturnType> >& initialNode):
